...
function GameDetail() {
    ...
    const [onAddFavorite, setOnAddFavorite] = React.useState(false)
    const [addedStatus, setAddedStatus] = React.useState(false)
    ...
    return (
        <>
            <div className={`${styles.onAddedFavorite} ${onAddFavorite ? " " + styles.onAddedFavoriteToggle : ''}`}>
                {addedStatus ? 'You are added favorite game' : 'Game already added'}
            </div>
